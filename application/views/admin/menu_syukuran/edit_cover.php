                            ...
                            <div class="p-1">
                                ...
                                <form class="user" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="nama" name="nama" value="<?= $cover['nama']; ?>" readonly>
                                    </div>
                                    <div class="picture-container">
                                        <div class="picture">
                                            <img src="<?= base_url('assets/images/syukuran/cover/') . $cover['image']; ?>" class="picture-src" id="wizardPicturePreview">
