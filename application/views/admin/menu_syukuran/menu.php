...
<div class="row">
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>Admin/edit_info_syukuran/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('Admin/tamu_syukuran'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>Admin/edit_cover_syukuran/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>Admin/gallery_syukuran/<?= $menu['id_user']; ?> " class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('Admin/edit_musik_syukuran/') . $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('Admin/edit_hitung_mundur_syukuran/') . $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('Admin/edit_amplop_syukuran/') . $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
