<div class="row">
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_mempelai_pria/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_mempelai_wanita/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_lokasi_mempelai/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/list_undangan/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/gallery/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_musik/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_hitung/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url(); ?>admin/edit_amplop/<?= $menu['id_user']; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
