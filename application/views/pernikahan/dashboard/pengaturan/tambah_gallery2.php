                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-1">
                                ...
                                <form method="POST" action="<?= base_url('DashboardPernikahan/tambah_gallery2'); ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="nama" placeholder="isi bebas" value="gallery" readonly>
                                    </div>
                                    <div class="picture-container">
                                        <div class="picture">
                                            <img src="<?= base_url('assets/images/gallery1.jpg'); ?>" class="picture-src" id="wizardPicturePreview" value="<?= set_value('image2'); ?>">
