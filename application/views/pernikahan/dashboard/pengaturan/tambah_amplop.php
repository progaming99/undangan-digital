<div class="row">
    <div class="col-lg">
        <div class="p-1">
            <form class="user" action="<?= base_url('DashboardPernikahan/tambah_amplop'); ?>" method="POST" enctype="multipart/form-data">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="no_hp" placeholder="Nomor Hanphone" value="<?= set_value('no_hp'); ?><?= $amplop['no_hp']; ?>"></input>
