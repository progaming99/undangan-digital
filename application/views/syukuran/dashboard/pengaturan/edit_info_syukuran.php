                            ...
                            <div class="p-1">
                                ...
                                <form class="user" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="picture-container">
                                        <div class="picture">
                                            <img src="<?= base_url('assets/images/syukuran/') . $info['image']; ?>" class="picture-src" id="wizardPicturePreview">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="nm_panggilan" name="nm_panggilan" placeholder="Nama Panggilan" value="<?= set_value('nm_panggilan'); ?><?= $info['nm_panggilan']; ?>">
                                        <?= form_error('nm_panggilan', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <div class="small mb-1 ml-3">Nama Lengkap</div>
                                        <input type="text" class="form-control form-control-user" id="nm_lengkap" name="nm_lengkap" placeholder="Nama Lengkap" value="<?= set_value('nm_lengkap'); ?><?= $info['nm_lengkap']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control form-control-user" id="w_mulai" name="w_mulai" value="<?= set_value('w_mulai'); ?><?= $info['w_mulai']; ?>">
                                        <?= form_error('w_mulai', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                    <div class="form-group">
                                        <div class="small mb-1 ml-3">Waktu Selesai</div>
                                        <input type="time" class="form-control form-control-user" id="w_selesai" name="w_selesai" value="<?= set_value('w_selesai'); ?><?= $info['w_selesai']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="alamat" name="alamat" placeholder="Alamat Lokasi" value="<?= set_value('alamat'); ?><?= $info['alamat']; ?>">
