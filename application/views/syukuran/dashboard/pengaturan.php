...
<div class="row">
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/edit_info_syukuran/') . $info->id_user; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
                    <img src="<?= base_url('assets/images/nama.jpg'); ?>" height="72" width="72">
                </div>
                <h6 class="m-0 font-weight-bold text-primary">Info Syukuran</h6>
            </div>
        </a>
    </div>
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/tamu_undangan'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/edit_cover/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/gallery'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/tambah_musik/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/edit_hitung_mundur/') . $hitung->id_user; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/amplop/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardSyukuran/desain/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
                    <img src="<?= base_url('assets/images/cover.jpg'); ?>" height="72" width="72">
                </div>
