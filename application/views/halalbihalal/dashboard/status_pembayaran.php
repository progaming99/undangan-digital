                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-lg mt-5">
                            <form class="user" action="<?= base_url('DashboardHalal/status_pembayaran'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-0">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('DashboardHalal'); ?>" class="btn btn-success btn-icon-split mt-2">
