...
<div class="card shadow mb-4">
    ...
    <div class="row">
        <?php foreach ($template_halal as $temp) : ?>
            <div class="col-6 col-md-6 mb-3 col-lg-3">
                <label>
                    ...
                    <div class="card-body text-center card h-100 mb-0 card-input">
                        <div class="mb-1">
                            <img class="card" src='<?= base_url() . "assets/images/halal/desain/$temp->gambar" ?>' alt="<?= $temp->nama_template; ?>" width="150" height="270">
                        </div>
                        <h6>
                            <?= $temp->nama_template; ?>
                        </h6>
...
<script>
    function simpanDesain() {
        ...
        $.ajax({
            url: '<?= base_url() . "DashboardHalal/simpanTemplate" ?>',
            type: "POST",
            dataType: "JSON",
            data: {
