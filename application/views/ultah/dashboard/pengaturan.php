...
<div class="row">
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/edit_nama/') . $nama->id_user; ?>" class="card h-100 mb-0">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/edit_lokasi/') . $lokasi->id_user; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/tambah_list'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/edit_cover/') . $cover->id_user; ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/gallery'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/tambah_musik/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/tambah_hitung/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/tambah_amplop/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
    ...
    <div class="col-6 col-md-6 mb-3 col-lg-3">
        <a href="<?= base_url('DashboardUltah/desain/'); ?>" class="card h-100 mb-0">
            <div class="card-body text-center">
                <div class="mb-1">
                    <img src="<?= base_url('assets/images/cover.jpg'); ?>" height="72" width="72">
                </div>
