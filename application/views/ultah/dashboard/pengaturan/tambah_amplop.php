<div class="row">
    <div class="col-lg">
        <div class="p-1">
            <form class="user" action="<?= base_url('DashboardUltah/tambah_amplop'); ?>" method="POST" enctype="multipart/form-data">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" name="an" placeholder="Atas Nama" value="<?= set_value('an'); ?><?= $amplop['an']; ?>"></input>
                            <?= form_error('an', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>
                        <div class="form-group">
                            <div class="small mb-1 ml-3">No Hp</div>
                            <input type="text" class="form-control form-control-user" name="no_hp" placeholder="No Handphone" value="<?= set_value('no_hp'); ?><?= $amplop['no_hp']; ?>"></input>
